...
public class LibrosController {
	...
	@Operation(summary = "Buusqueda de libros por tematica" , description= "devuelve todos los libros de la misma temática")// estas anotaciones sirven para documentar el programa
